...
**Patch:** 0.6.3 (placeholder text size SELF-CALIBRATED against Photoshop's own rasterized pixels — substituted text always matches the design's original text size, immune to engine-data unit quirks)
